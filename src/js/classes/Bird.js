class Bird {
  constructor(species, nbIndividuals, positionX, positionY, reproductionRate, state, pictureSource) {
    ...
    this.age = 0;
    this.lastVisitedColor = 'orange'; //Dernière zone visitée par les oiseaux migrateurs
    this.goal = [8, 12]; //Objectif de départ de la population des oiseaux migrateurs
    this.spentTime = 0;
  ...
  //S'il n'y a plus d'individu dans la population celle ci disparait de la map
  ...
  //Utilisation de l'algo A* pour trouver le plus court chemin
